...
var displayMap = function displayMap(locations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoicHJhbmphbDE2IiwiYSI6ImNsMzdpYzF6czAxbXQzYm1uOXI1YzFnZmYifQ.DZ1-bI8SeuSVHMLyelDDXQ';
  ...
  locations.forEach(function (loc) {
    // create marker
    var el = document.createElement('div'); // creating new html element
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlerts)('success', 'Logged in successfully'); // to send the cookie with valid token to the server to login the user
...
exports.login = login;
},{"axios":"../../node_modules/axios/index.js","./alerts.js":"alerts.js"}],"logout.js":[function(require,module,exports) {
"use strict";
...
console.log('hello from the client side updateSettings.js'); // type is either 'passowrd' or 'data'
...
var stripe = Stripe('pk_test_51L13CwSDeZD4SCcjoePXDoJrGcNBtXu22XsO0cd83GirZbNbL8LW8uJ0A18XcjNodizY0ZgX0AOaDvUe14Xg8QsP00l7FMeqew');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 9:
            ...
            (0, _alerts.showAlerts)('error', _context.t0.message);
...
if (userDataForm) {
  ...
  userDataForm.addEventListener('submit', function (e) {
    ...
    var email = document.getElementById('email').value;
    var photo = document.getElementById('photo').files[0]; // re-creating multipart form data to upload image file

    var form = new FormData();
    form.append('name', name);
    form.append('email', email);
    form.append('photo', photo); // to console form data
